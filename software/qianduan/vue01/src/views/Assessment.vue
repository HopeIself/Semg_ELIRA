    ...
    <div class="content">
      ...
      <div class="right">
        ...
        <div class="input-section">
          ...
          <p class="tip-text">
  如果需要生成AI计划进行训练，请选择“生成计划”；<br>
  如果需要评估肌肉状态生成报告，请选择“状态记录”。<br>
  完成评估后请点击下一步。
</p>
        </div>
        ...
        <p class="completion-tip">评估已完成，请点击“下一步”继续。</p>
...
export default {
  ...
  if (this.code === '1') {
    ...
    startAssessment() {
      ...
      // SSE连接地址
      const url = `http://115.190.134.66:5000/api/initial_assessment?id=${encodeURIComponent(this.id)}&code=${encodeURIComponent(this.code)}`;
