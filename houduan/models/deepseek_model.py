...
class DeepSeekSession:
    ...
    建议：模拟生活/工作动作，预防过劳与复发}}",
        ...
        "{{建议1：具体可行，结合用户当前表现，用具体动作替代动作序号，注意如果三个动作的平均percent低于80，或者相比于昨天/三天前/七天前退步达到20%，则告知用户尽快前往医院诊断（非常重要，非常重要）}}",
        "{{建议2，如果相比于昨天/三天前/七天前退步达到20%，则告知用户尽快前往医院诊断（非常重要，非常重要）}}",
        "{{建议3，如果相比于昨天/三天前/七天前退步达到20%，则告知用户尽快前往医院诊断（非常重要，非常重要）}}",
        "{{建议4：下一次的康复位置：结合患者的恢复状况，主诉部位，给出下一次的康复计划建议，如果患者的手掌恢复较好，下一次动作建议：腕屈曲，xx组，腕伸展，xx组，压手，xx组}}",
        ]
    },
    "model_info": {
        "inference_model": "Deepseek-EMG",
        "notes": "本报告结果仅供康复参考使用。"
    }
    }
